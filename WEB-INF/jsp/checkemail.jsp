        ...
        <div class="col-xs-10 col-sm-10 col-md-10">
            ...
            <div class="row zczt">
                ...
                <div class="col-xs-offset-1 col-xs-5" id="regist_3">
                    <div class="row zczt">
                        Congratulations on successful registration, <a href="index.jsp">click here to return to homepage</a>
                    </div>
                </div>
                <div class="col-xs-6">
                    <h3>
                    ...
                    <ul>
                        <li>
                            Purchase and download full retail games
                        </li>
                        <li>
                        ...
                        <li>
                            Schedule games, tournaments, or LAN parties
                        </li>
                        <li>
