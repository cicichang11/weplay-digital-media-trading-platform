...
<div class="container">
    ...
    <div class="row" style="background-color:#3D6C8D">
        <h3 align="center" style="color:#C6D4DF">Please Select Payment Method</h3>
    </div>
    <br>
    <br>
    <div class="row">
    ...
    <div class="row">
        <div class="col-xs-10" style="color:#F00;">
            <h4 align="left">Please ensure your bank card has online payment enabled, otherwise payment may fail.</h4>
        </div>
        <div class="col-xs-2">
            <a href="/order/${id}/pay">
                <button type="submit" style="height:40px;width:80px">Proceed to Pay</button>
            </a>
        </div>
    </div>
</div>
