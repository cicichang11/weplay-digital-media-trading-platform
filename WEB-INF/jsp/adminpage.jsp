...
<html>
<head>
    <title>Weplay Admin Management System</title>
...
<div class="top"></div>
<div id="header">
    <div class="logo">Weplay Admin Management System</div>
</div>
<div id="content">
    <div class="left_menu">
        <ul id="nav_dot">
            <li>
                ...
                <div class="list-item none">
                    <a href="#" onclick="showright_0()">Information</a>
                </div>
            </li>
            <li>
                <h4 class="M2"><span></span>Category Management</h4>
                <div class="list-item none">
                    <a href="#" onclick="showright_3()">Information</a>
                </div>
            </li>
            <li>
                <h4 class="M3"><span></span>Game Management</h4>
                <div class="list-item none">
                    <a href="#" onclick="showright_1()">Information</a>
                </div>
                <div class="list-item none">
...
<div id="footer"><p>All final rights belong to <a href="" target="_blank">Weplay</a></p></div>
